...
**Stack:** Astro 5 (static output) + React islands where earned, deployed to
...
| [1 — Design & content](phase-1-pipeline.md) | Tokens, components, content collections | ~1 day |
| [2 — Pages](phase-2-pages.md) | Every route rendering real data | ~1 day |
